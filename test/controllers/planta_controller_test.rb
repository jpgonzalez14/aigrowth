...
class PlantaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plantum" do
    assert_difference('Plantum.count') do
      post planta_url, params: { plantum: { huerta_id: @plantum.huerta_id, nombre: @plantum.nombre } }
    end
  ...
  test "should update plantum" do
    patch plantum_url(@plantum), params: { plantum: { huerta_id: @plantum.huerta_id, nombre: @plantum.nombre } }
